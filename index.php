...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarColor02">
          <ul class="navbar-nav me-auto">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">USER LOGIN</a>
    ...
    <div class="event-section">
      ...
      <div class="text-box">
        ...
        if (isset($_SESSION['loggin'])) {
          echo 'echo <a href="event1.php" class="event-btn">View Events</a>';
        } else {
  ...
  <div class="signUp-section">
    ...
    <div class="text-box">
      ...
      <a href="users/login.php" class="signup-btn">Shopping!</a>
    </div>
  </div>
